...
import { S as ScrollArea, U as Users } from "./scroll-area-CwZfMy6F.js";
...
import { W as Wrench } from "./wrench-B4Je6gyv.js";
...
const useDashboardStore = create((set2, get2) => ({
  ...
  refreshData: async () => {
    ...
    const __ver = (get2()._refreshVersion || 0) + 1;
    set2({ _refreshVersion: __ver });
    setLoading(true);
    setError(null);
    try {
      ...
      if (get2()._refreshVersion !== __ver) { setLoading(false); return; }
